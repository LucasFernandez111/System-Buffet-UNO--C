...
bool placeOrder(int idTotal[], char foodTotal[], int cantTotal[],int *countOrder);
void modify(int idTotal[], char foodTotal[], int cantTotal[]);
void history(int idTotal[], char foodTotal[], int cantTotal[],int *countOrder);
void cancel(int idTotal[], char foodTotal[], int cantTotal[],int *countOrder);
...
int main() {
    int option, idTotal[MAX] = {0}, cantTotal[MAX] = {0},countOrder=0;
    ...
    do {
        ...
        switch (option) {
            case 1:
                placeOrder(idTotal, foodTotal, cantTotal,&countOrder);
                break;
            case 2:
                showMenuFood();
                system("pause");
                break;
            case 3:
                history(idTotal, foodTotal, cantTotal,&countOrder);
                system("pause");
                break;
            case 4:
                ...
                break;
            case 5:
                cancel(idTotal, foodTotal, cantTotal,&countOrder);
                system("pause");
                break;
...
bool next=false;
    ...
    do {
       ...
       do{
        ...
        if(nameProduct == 'A'||  nameProduct == 'B' ||  nameProduct == 'C' ||  nameProduct == 'D' ||  nameProduct == 'E')  next = true;
